...
! function(t, e) {
    ...
    var y = "collapse",
        ...
        C = function() {
            function t(t, e) {
                this._isTransitioning = !1, this._element = t, this._config = this._getConfig(e), this._triggerArray = [].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="<?=  base_url();  ?>#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]'));
        ...
        rt = function() {
            ...
            return n.refresh = function() {
                ...
                var n = this._selector.split(",").map((function(e) {
                        return e + '[data-target="' + t + '"],' + e + '[href="<?=  base_url();  ?>' + t + '"]'
                    })),
